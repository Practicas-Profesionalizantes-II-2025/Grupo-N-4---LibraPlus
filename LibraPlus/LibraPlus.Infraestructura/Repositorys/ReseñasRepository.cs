...
namespace LibraPlus.Infraestructura.Repositorys
{
    public class ReseñasRepository : IReseñasRepository
    {
        ...
        public ReseñasRepository(ProyectDBContext context)
        {
            _context = context;
        }
        ...
        Task<Reseñas> IReseñasRepository.GetByIdAsync(int id)
        {
            throw new NotImplementedException();
        }

        Task<IEnumerable<Reseñas>> IReseñasRepository.GetAllAsync()
        {
            throw new NotImplementedException();
        }
        ...
        Task<IEnumerable<Reseñas>> IReseñasRepository.GetByLibroIdAsync(int libroId)
        {
            throw new NotImplementedException();
        }

        Task<IEnumerable<Reseñas>> IReseñasRepository.GetByUsuarioIdAsync(int usuarioId)
        {
            throw new NotImplementedException();
        }
    }
